...
int wmain(int argc, wchar_t* argv[]) {
    ...
    wchar_t deviceInstancePath[] = L"SWD\\DEVGEN\\????"; // first simulated battery
    swprintf_s(deviceInstancePath, L"SWD\\DEVGEN\\%04i", batteryIdx); // replace ???? with a 4-digit integer 
